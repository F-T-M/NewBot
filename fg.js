...
linkgp = await Fg.groupInviteCode (from)
    ...
    if (budy.includes(`https://chat.whatsapp.com/Ly4I2LObSvW8VgOnJjofgE`)) return reply('✳️ Menos mal que este enlace es del grupo *📲💻ANDROID WORLD🎬🎮* v:')
...
if (!isVerify) return reply(userB(prefix))
  if (isBanned) return reply(banf())
const fgnum = `51964441224@s.whatsapp.net`
const crisnum = "51964441224@s.whatsapp.net"
...
*Verificación completa pon* *${prefix}Help* *para ver el Menu*`
...
if (isGroup && budy != undefined) {
	...
	console.log(color('[BOSS]', 'red'), 'Chat PRIVADO', color(sender.split('@')[0]))
	}		
} catch (e) {
     e = String(e) 
